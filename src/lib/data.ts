...
export const projects: Project[] = [
  {
    ...
    year: "2025",
    description:
      "Site institucional desenvolvido com Next.js, TypeScript e Tailwind. Layout responsivo e foco em performance.",
    stack: ["Next.js", "TypeScript", "Tailwind"],
    cover: "potencial",
    href: "https://potencial-vert.vercel.app/",
  },
  {
    id: "cartorio",
    index: "02",
    ...
    year: "2024",
    description:
      "Site institucional para escritório de cartório. React e Tailwind com layout responsivo e seções organizadas.",
  ...
  },
  {
    ...
    year: "2025",
    description:
      "Aplicação React inspirada na categoria de corridas elétricas. Componentes reutilizáveis e consumo de API.",
